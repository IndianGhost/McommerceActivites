...
public class ClientController {
    ...
    public ClientController(MicroserviceProduitsProxy produitsProxy, MicroserviceCommandeProxy commandesProxy, MicroservicePaiementProxy paiementProxy, MicroserviceExpeditionProxy expeditionProxy) {
    ...
    public String suivreCommande(@PathVariable int idCommande, Model model) {
        ExpeditionBean expedition = expeditionProxy.getExpeditionByIdCommande(idCommande);
